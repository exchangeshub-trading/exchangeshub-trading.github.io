...
const Header = () => {
  ...
  const nabarAreaCssClass = menu ? 'navbar-area' : 'navbar-area active';
  const navbarSupportedContentcssClass = menu ? 'collapse navbar-collapse' : 'collapse navbar-collapse show';
  const navbarTogglerCssClass = menu ? 'navbar-toggler navbar-toggler-right collapsed' : 'navbar-toggler navbar-toggler-right';

  return (
    <>
      <div id='navbar' className={nabarAreaCssClass}>
        <div className='main-navbar' data-aos='fade-in' data-aos-delay='300' data-aos-duration='1000' data-aos-once='true'>
      ...
      <div className={`sidebarModal modal right ${isActiveSidebarModal ? 'show' : ''}`}>
        <div className='modal-dialog' ref={sidebarRef}>
          <div className='modal-content'>
            ...
            <div className='modal-body'>
              ...
              <div className='sidebar-content'>
                <p>ExchangesHub (powered by Tech1) is a platform to automate your crypto profits via trading bots on Binance, Bitfinex, and Kraken</p>
              </div>
